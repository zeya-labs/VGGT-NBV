...
def __getattr__(name: str):
    if name in {
        ...
        return {
            "compute_pinhole_intrinsics": compute_pinhole_intrinsics,
            "pose7d_to_opencv_cam2world_with_official_func": pose7d_to_opencv_cam2world_with_official_func,
            "prepare_mapanything_views": prepare_mapanything_views,
        }[name]
